...
<body>
	...
	<div class="main-container">	
      ...
      <div class="logout">
		...
		<form action="create-nft.jsp" method="get">			
			<div>
				<label>
					Name
				</label>
				<br>
				<input class="input" name="name" type="text" onfocus="this.value=''">
			</div>
			<div>
				<label>
					URL
				...
				<br>
				<input class="input" name="url" type="text" onfocus="this.value=''">
			</div>		
			<br>
	 			...
	 			if(name!=null && url!=null){	 		 
	     			if(!name.trim().equals("") && !url.trim().equals("")) {
	                 	try {
             				...
             				String queryString = "INSERT INTO nfts(nft_name,url,creator,nft_owner) VALUES (?, ?, ?, ?);";
